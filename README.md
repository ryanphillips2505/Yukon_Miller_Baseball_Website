...
- Real program copy from the current public site (staff names, fields, HRC officers, sponsorships, Clayton Strange’s Hutchinson CC commit, TCA store code)
