...
export const seniors2026Story = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "A talented and versatile player during his time at Yukon, Fish was a key contributor for the Millers and earned the opportunity to continue his career at the Division I level.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "A dependable arm for the Millers, Trogdon developed into an important part of the Yukon pitching staff and now gets the opportunity to continue that development at the Division I level.",
    },
    {
      type: "h2",
    ...
    {
      type: "p",
      text: "Butler is continuing his baseball career at the University of Science and Arts of Oklahoma, joining the Drovers.",
    },
    {
      type: "p",
      text: "Butler was a member of the Yukon Millers and is now taking his talents to the collegiate level as he begins the next chapter of his baseball career.",
    },
    {
      type: "h2",
